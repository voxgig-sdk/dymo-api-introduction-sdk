...
```bash
cd go-mcp && go build -o dymo-api-introduction-mcp .
```
...
```json
{
  "mcpServers": {
    "dymo-api-introduction": {
      "command": "/abs/path/to/dymo-api-introduction-mcp"
    }
  }
}
```
...
Generated from the Dymo API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
