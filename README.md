...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dymo-api-introduction` | `npm install @voxgig-sdk/dymo-api-introduction` |
| Python | `voxgig-sdk-dymo-api-introduction` | `pip install voxgig-sdk-dymo-api-introduction` |
| PHP | `voxgig-sdk/dymo-api-introduction` | `composer require voxgig-sdk/dymo-api-introduction` |
| Golang | `github.com/voxgig-sdk/dymo-api-introduction-sdk/go` | `go get github.com/voxgig-sdk/dymo-api-introduction-sdk/go` |
| Ruby | `voxgig-sdk-dymo-api-introduction` | `gem install voxgig-sdk-dymo-api-introduction` |
| Lua | `voxgig-sdk-dymo-api-introduction` | `luarocks install voxgig-sdk-dymo-api-introduction` |
