...
The Dymo API provides a comprehensive solution for businesses by integrating security, AI, marketing, and analytics into a single platform.

Learn more about Dymo API at [dymo.com](https://dymo.com).

This is an unofficial SDK for the Dymo public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Security — that you
...
const client = DymoApiIntroductionSDK.test({
  entity: {
    security: {
      test01: { id: 'test01', data: {} },
    },
  },
})
const security = await client.Security().create({ data: {} })
// security is the Security entity, populated with mock data
...
```go
client := sdk.Test()
result, err := client.Security(nil).Create(
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dymo-api-introduction` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dymo-api-introduction-sdk/releases) |
| Python | `voxgig-sdk-dymo-api-introduction` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dymo-api-introduction-sdk/releases) |
| PHP | `voxgig-sdk/dymo-api-introduction` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dymo-api-introduction-sdk/releases) |
| Golang | `github.com/voxgig-sdk/dymo-api-introduction-sdk/go` | `go get github.com/voxgig-sdk/dymo-api-introduction-sdk/go@latest` |
| Ruby | `voxgig-sdk-dymo-api-introduction` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dymo-api-introduction-sdk/releases) |
| Lua | `voxgig-sdk-dymo-api-introduction` | publish pending — [install from git tag](https://github.com/voxgig-sdk/dymo-api-introduction-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/dymo-api-introduction-sdk/go-cli` | `go install github.com/voxgig-sdk/dymo-api-introduction-sdk/go-cli/cmd/dymo-api-introduction@latest` |
| Go MCP server | `github.com/voxgig-sdk/dymo-api-introduction-sdk/go-mcp` | `go get github.com/voxgig-sdk/dymo-api-introduction-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Security** | The Security entity (create). | `/validate` |
...
- Upstream API: [https://tpe.li/D-DMAPI](https://tpe.li/D-DMAPI)
