# DymoApiIntroduction SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # DymoApiIntroductionSDK.new, not DymoApiIntroductionSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    DymoApiIntroductionSDK.new(opts)
  end
