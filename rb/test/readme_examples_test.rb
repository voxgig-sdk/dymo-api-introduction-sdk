...
#      offline in seeded test mode (DymoApiIntroductionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DymoApiIntroduction_sdk.rb")
  SDK_CLASS = "DymoApiIntroductionSDK"
  ...
  SDK_BASE = "DymoApiIntroduction_sdk"
