...
func registerSDKWords(r *eng.Registry, client *sdk.DymoApiIntroductionSDK) {
...
func runOp(client *sdk.DymoApiIntroductionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
