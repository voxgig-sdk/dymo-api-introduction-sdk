// Command DymoApiIntroduction-cli is a CLI + REPL for the DymoApiIntroduction SDK,
...
const prompt = "dymo-api-introduction"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "security"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      DYMO_API_INTRODUCTION_APIKEY (api key), DYMO_API_INTRODUCTION_BASE (base url override)")
