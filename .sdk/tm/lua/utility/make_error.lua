...
local function make_error_util(ctx, err)
  ...
  local msg = "DymoApiIntroductionSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = DymoApiIntroductionError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == DymoApiIntroductionError then
