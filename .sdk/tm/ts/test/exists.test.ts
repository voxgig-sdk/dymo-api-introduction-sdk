...
describe('exists', async () => {
  ...
  //
  // DymoApiIntroductionSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof DymoApiIntroductionSDK, true,
      'DymoApiIntroductionSDK.test() must return a client synchronously')
  })
