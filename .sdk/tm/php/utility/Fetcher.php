...
// DymoApiIntroduction SDK utility: fetcher

class DymoApiIntroductionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DymoApiIntroductionSDK/1.0)';
    ...
    public static function call(DymoApiIntroductionContext $ctx, string $fullurl, array $fetchdef): array
    {
