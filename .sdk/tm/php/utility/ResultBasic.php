...
// DymoApiIntroduction SDK utility: result_basic

class DymoApiIntroductionResultBasic
{
    public static function call(DymoApiIntroductionContext $ctx): ?DymoApiIntroductionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof DymoApiIntroductionError) ? $result->err->msg : (string)$result->err;
