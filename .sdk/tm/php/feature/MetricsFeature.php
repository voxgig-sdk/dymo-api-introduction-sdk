...
// DymoApiIntroduction SDK metrics feature
...
class DymoApiIntroductionMetricsFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _record(DymoApiIntroductionContext $ctx, bool $ok): void
    {
