...
// DymoApiIntroduction SDK clienttrack feature
...
class DymoApiIntroductionClienttrackFeature extends DymoApiIntroductionBaseFeature
{
    ...
    public function PostConstruct(DymoApiIntroductionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DymoApiIntroduction-SDK';
