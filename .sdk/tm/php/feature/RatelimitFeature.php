...
// DymoApiIntroduction SDK ratelimit feature
...
class DymoApiIntroductionRatelimitFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _acquire(DymoApiIntroductionContext $ctx): void
    {
    ...
    private function _track(DymoApiIntroductionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
