...
// DymoApiIntroduction SDK audit feature
...
class DymoApiIntroductionAuditFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _emit(DymoApiIntroductionContext $ctx, string $outcome): void
    {
