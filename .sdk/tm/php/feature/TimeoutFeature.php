...
// DymoApiIntroduction SDK timeout feature
...
class DymoApiIntroductionTimeoutFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _with_timeout(DymoApiIntroductionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DymoApiIntroductionContext $_ctx, float $ms): void
    {
        $client = $this->client;
