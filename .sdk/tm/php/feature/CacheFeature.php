...
// DymoApiIntroduction SDK cache feature
...
class DymoApiIntroductionCacheFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _through(DymoApiIntroductionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
