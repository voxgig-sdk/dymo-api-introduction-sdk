...
type Args struct {
	Entity string         `json:"entity" jsonschema:"security"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DymoApiIntroductionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dymo-api-introduction_list",
		Description: "List records from DymoApiIntroduction. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dymo-api-introduction_load",
		Description: "Load a single record from DymoApiIntroduction. " +
...
func runOp(client *sdk.DymoApiIntroductionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DymoApiIntroductionSDK, name string) (sdk.DymoApiIntroductionEntity, error) {
