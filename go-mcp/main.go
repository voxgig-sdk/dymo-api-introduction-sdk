// Command DymoApiIntroduction-mcp is an MCP server exposing the DymoApiIntroduction
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DymoApiIntroduction_list  — list records of an entity
//	DymoApiIntroduction_load  — load a single record of an entity
//
