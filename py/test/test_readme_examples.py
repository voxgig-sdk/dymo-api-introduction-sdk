# DymoApiIntroduction SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DymoApiIntroductionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DymoApiIntroductionSDK(...) and DymoApiIntroductionSDK.test(...) become
#      DymoApiIntroductionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dymoapiintroduction_sdk"
_SDK_CLASS = "DymoApiIntroductionSDK"
