# DymoApiIntroduction SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from dymoapiintroduction_sdk import DymoApiIntroductionSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"DymoApiIntroductionSDK": DymoApiIntroductionSDK, "os": os}
        try:
