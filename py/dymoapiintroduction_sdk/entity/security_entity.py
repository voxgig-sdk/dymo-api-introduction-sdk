...
from dymoapiintroduction_sdk.dymoapiintroduction_types import (
    Security,
    SecurityCreateData,
)
...
class SecurityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SecurityEntity(self._client, opts)
    ...
    def create(self, reqdata: SecurityCreateData, ctrl=None) -> Security:
        utility = self._utility
