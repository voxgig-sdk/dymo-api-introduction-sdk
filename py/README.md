# DymoApiIntroduction Python SDK

The Python SDK for the DymoApiIntroduction API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.Security(None).create({"name": "Example"}, None)
...
result, err = client.DymoApiIntroduction(None).load(
    {"id": "test01"}, None
)
...
```
py/
├── dymoapiintroduction_sdk.py         -- Main SDK module
