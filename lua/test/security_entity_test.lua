...
describe("SecurityEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DYMOAPIINTRODUCTION_TEST_SECURITY_ENTID JSON to run live")
      return
    end
...
function security_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DYMOAPIINTRODUCTION_TEST_SECURITY_ENTID")
  ...
  local live = env["DYMOAPIINTRODUCTION_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
