...
// DymoApiIntroduction SDK proxy feature
...
class DymoApiIntroductionProxyFeature extends DymoApiIntroductionBaseFeature
{
    ...
    public function init(DymoApiIntroductionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DymoApiIntroductionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
