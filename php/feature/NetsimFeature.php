...
// DymoApiIntroduction SDK netsim feature
...
class DymoApiIntroductionNetsimFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _simulate(DymoApiIntroductionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DymoApiIntroductionContext $ctx, array $applied): void
    {
        $client = $this->client;
