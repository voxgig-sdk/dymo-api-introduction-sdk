...
// DymoApiIntroduction SDK rbac feature
...
class DymoApiIntroductionRbacFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _required(DymoApiIntroductionContext $ctx): ?string
    {
    ...
    private function _reject(DymoApiIntroductionContext $ctx, string $required): void
    {
    ...
    private function _track(DymoApiIntroductionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
