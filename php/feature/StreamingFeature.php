...
// DymoApiIntroduction SDK streaming feature
...
class DymoApiIntroductionStreamingFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _iterate(DymoApiIntroductionResult $result): \Generator
    {
    ...
    private function _streamable(DymoApiIntroductionContext $ctx): bool
    {
