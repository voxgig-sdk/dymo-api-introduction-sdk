...
// DymoApiIntroduction SDK telemetry feature
...
class DymoApiIntroductionTelemetryFeature extends DymoApiIntroductionBaseFeature
{
    ...
    private function _close(DymoApiIntroductionContext $ctx, bool $ok): void
    {
