...
// DymoApiIntroduction SDK utility: graphql
//
...
class DymoApiIntroductionGraphql
{
    ...
    // equivalent.
    public static function body(DymoApiIntroductionContext $ctx): mixed
    {
    ...
    public static function errors(DymoApiIntroductionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
