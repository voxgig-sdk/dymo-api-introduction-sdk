...
// DymoApiIntroduction SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DymoApiIntroductionMakeRequest
{
    public static function call(DymoApiIntroductionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DymoApiIntroductionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DymoApiIntroductionResponse($fetched);
        } else {
