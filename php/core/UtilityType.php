...
// DymoApiIntroduction SDK utility type

class DymoApiIntroductionUtility
{
    ...
    public static function copy(DymoApiIntroductionUtility $src): DymoApiIntroductionUtility
    {
        $u = new DymoApiIntroductionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
