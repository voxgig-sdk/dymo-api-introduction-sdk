...
class DymoApiIntroductionTestRunner
{
    ...
    {
        $live = self::getenv('DYMOAPIINTRODUCTION_TEST_LIVE');
        $override = self::getenv('DYMOAPIINTRODUCTION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DYMOAPIINTRODUCTION_TEST_EXPLAIN');
