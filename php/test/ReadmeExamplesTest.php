...
// DymoApiIntroduction SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DymoApiIntroductionSDK::test)
...
{
    private const SDK_CLASS = 'DymoApiIntroductionSDK';
    ...
    private const SDK_BASE = 'dymoapiintroduction_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dymoapiintroduction_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
