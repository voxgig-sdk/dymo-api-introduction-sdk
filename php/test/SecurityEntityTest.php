...
class SecurityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DYMOAPIINTRODUCTION_TEST_SECURITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function security_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DYMOAPIINTRODUCTION_TEST_SECURITY_ENTID");
