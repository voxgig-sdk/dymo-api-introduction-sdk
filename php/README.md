# DymoApiIntroduction PHP SDK



The PHP SDK for the DymoApiIntroduction API — an entity-oriented client using PHP conventions.
...
```
php/
├── dymoapiintroduction_sdk.php          -- Main SDK class
...
The main class (`dymoapiintroduction_sdk.php`) exports the SDK class
