...
The PHP SDK for the DymoApiIntroduction API. Provides an entity-oriented interface using PHP conventions.


## Install
```bash
composer require voxgig/dymo-api-introduction-sdk
```
...
```php
// Create
[$created, $_] = $client->Security(null)->create(["name" => "Example"], null);
...
[$result, $err] = $client->DymoApiIntroduction(null)->load(
    ["id" => "test01"], null
);
