...
type SecurityEntity struct {
	name    string
	client  *core.DymoApiIntroductionSDK
...
func NewSecurityEntity(client *core.DymoApiIntroductionSDK, entopts map[string]any) *SecurityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SecurityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SecurityEntity) List(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *SecurityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SecurityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
