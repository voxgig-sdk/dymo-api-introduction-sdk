...
type Security struct {
	AiInsights *map[string]any `json:"aiInsights,omitempty"`
	Analytics *map[string]any `json:"analytics,omitempty"`
	Data map[string]any `json:"data"`
	EnableAI *bool `json:"enableAI,omitempty"`
	MarketingInsights *map[string]any `json:"marketingInsights,omitempty"`
	Status *string `json:"status,omitempty"`
	Timestamp *string `json:"timestamp,omitempty"`
	ValidationResults *map[string]any `json:"validationResults,omitempty"`
