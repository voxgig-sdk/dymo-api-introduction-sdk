# DymoApiIntroduction TypeScript SDK Reference

Complete API reference for the DymoApiIntroduction TypeScript SDK.
...
```ts
new DymoApiIntroductionSDK(options?: object)
```
...
#### `DymoApiIntroductionSDK.test(testopts?, sdkopts?)`
...
**Returns:** `DymoApiIntroductionSDK` instance in test mode.
...
Alias for `DymoApiIntroductionSDK.test()`.
...
Return the parent `DymoApiIntroductionSDK` instance.
